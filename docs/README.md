...
| Shell | `SHL` | [Idea](shell/IDEA.md) · [Roadmap](shell/ROADMAP.md) | Channel composition, navigation, shared feedback, and diagnostics |
| Today | `TOD` | [Idea](today/IDEA.md) · [Roadmap](today/ROADMAP.md) | Clock, date, weather, forecast, and morning dashboard |
...
| Camera | `CAM` | [Idea](camera/IDEA.md) · [Roadmap](camera/ROADMAP.md) | Deliberate local camera mirror and controls |
| AirPlay | `AIR` | [Idea](airplay/IDEA.md) · [Roadmap](airplay/ROADMAP.md) | On-demand iPhone screen mirroring and native composition |
